...
const EditNotes = ({handleEditNote,data}) => {
  ...
  useEffect(()=>{
    ...
    return (
      <>
 <div className='flex flex-col w-full items-center max-h-screen dark:bg-primary bg-[#ffffff] overflow-hidden'>       
        <div className='md:w-3/5  w-full p-0 overflow-hidden'>
        <div className='px-3 pt-3 flex flex-col h-screen overflow-hidden'>
      ...
      <div className='dark:bg-[#171c26] bg-[#dde1fa] bottom-0 absolute h-48 px-4  pt-4 rounded-t-[2rem] w-full md:w-3/5 overflow-hidden'>
