...
const SearchBox = () => {
  return (
    ...
    <input  type="text" name="" id="" className=' bg-[#dce1e7] dark:bg-[#171c26]  w-full h-12 p-2 focus:outline-none  text-sm rounded-2xl  font-Roboto text-[#000000] dark:text-[#dce1e7]  placeholder:dark:text-[#dce1e7] placeholder:text-[#000000] placeholder:tracking-tighter	' placeholder='Search your notes' />
