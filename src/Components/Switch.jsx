...
const Switch = () => {
  ...
  return (
    <div className={isSelected==false?`flex w-12 items-center h-7 bg-[#043449] rounded-full  transition-all  shadow-2xl cursor-pointer `:' cursor-pointer flex w-12  items-center h-7  rounded-full  transition-all  shadow-2xl bg-[#fbedb6]'} onClick={()=>setIsSelected(!isSelected)}>
